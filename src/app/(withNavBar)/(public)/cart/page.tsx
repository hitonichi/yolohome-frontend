            ...
            <CardContent>
              <div className="grid grid-cols-2 justify-between">
                ...
                <div className="flex flex-col justify-start items-end font-semibold">
                  <div>$ {to2Decimal(subtotal)}</div>
                  <div>$ {to2Decimal(SHIPPING_FEE)}</div>
                  <div>$ {to2Decimal(subtotal * 0.08)}</div>
                </div>
                <div className="mt-4 col-span-full w-full flex">
                  <Input className="grow" placeholder="Enter promo code" />
                ...
                <div className="flex flex-col justify-start items-end font-semibold">
                  <Label className="font-semibold">$ {to2Decimal(subtotal * 1.08 + SHIPPING_FEE)}</Label>
                </div>
